...
function AppShell() {
  ...
  // O PrivacyProvider fica AQUI, depois dos returns antecipados das rotas de
  // preview — nunca em volta do AppShell nem ao lado do AuthProvider. As rotas
  // /voucher-preview/... precisam renderizar FORA da árvore do provider, senão
  // o voucher real do cliente sairia borrado na exportação.
  return (
    <PrivacyProvider>
